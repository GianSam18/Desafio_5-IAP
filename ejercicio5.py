...
st.set_page_config(page_title="Mi chat de IA - Samanez", page_icon="🐶")  # Configura el título y el ícono de la página

st.title("Mi primera aplicación con Streamlit - Samanez")  # Muestra un título grande en la página
...
if st.button("Saludar"): #Crea un botón que dice "Saludar"
    st.write(f"¡Hola, {nombre}! gracias por venir a Talento Tech")  # Muestra un mensaje personalizado cuando aprieta el botón
